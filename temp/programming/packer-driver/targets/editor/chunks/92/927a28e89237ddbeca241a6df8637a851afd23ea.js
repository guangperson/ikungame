  ...
  return {
    ...
    execute: function () {
      ...
      _export("main", main = (_dec = ccclass('main'), _dec2 = property(AudioSource), _dec(_class = (_class2 = class main extends Component {
        ...
        initMusic() {
          // 获取 AudioSource 组件
          const audioSource = this.node.getChildByPath("buttons/buttons1/Button-000").getComponent(AudioSource);
...
//# sourceMappingURL=927a28e89237ddbeca241a6df8637a851afd23ea.js.map
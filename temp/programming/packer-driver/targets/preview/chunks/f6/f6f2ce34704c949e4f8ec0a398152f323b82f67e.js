    ...
    execute: function () {
      ...
      _export("main", main = (_dec = ccclass('main'), _dec2 = property(AudioSource), _dec(_class = (_class2 = class main extends Component {
        ...
        initTopBeiJing() {
          ...
          assetManager.loadBundle('assetsResours', /*#__PURE__*/_asyncToGenerator(function* (err, ab) {
            ...
            ab.load('json/text', JsonAsset, (err, resAsset) => {
              ...
              var row1 = json.row1;
              _this._audioSource = AudioSource[row1.length];
              console.log(_this._audioSource);
              console.log("==");
        ...
        initMusic(len, btnName) {
          ...
          this._audioSource[len] = audioSource;
        }

        play() {// 播放音乐
          //  for(let i = 0;i<this._audioSource.length;i++){
          //  }
...
//# sourceMappingURL=f6f2ce34704c949e4f8ec0a398152f323b82f67e.js.map
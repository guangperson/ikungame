System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, assetManager, Sprite, _dec, _class, _crd, ccclass, property, main;
      ...
      _export("main", main = (_dec = ccclass('main'), _dec(_class = class main extends Component {
        start() {
          assetManager.loadBundle("assetsResours", (err, ab) => {
            ...
            var topSprite = this.node.getChildByPath("topbackground").getComponent(Sprite);
...
//# sourceMappingURL=4c4704683df4f5d2def8059ff6bb11b88ad95fb4.js.map